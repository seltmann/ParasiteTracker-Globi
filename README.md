[![Build Status](https://travis-ci.org/seltmann/template-dataset.svg)](https://travis-ci.org/seltmann/template-dataset) [![DOI](https://zenodo.org/badge/26293374.svg)](https://zenodo.org/badge/latestdoi/26293374) [![GloBI](http://api.globalbioticinteractions.org/interaction.svg?accordingTo=globi:seltmann/template-dataset)](http://globalbioticinteractions.org/?accordingTo=globi:seltmann/template-dataset) 
